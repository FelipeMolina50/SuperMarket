...
<head>
    ...
    <style>
        ...
        .header { background-color: #ffffff; padding: 1rem; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--border-color); box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05); }
...
<body class="flex min-h-screen">
    ...
    <aside class="sidebar">
        <div class="sidebar-header flex justify-between items-center">
            ...
            <button id="closeSidebarBtn" class="lg:hidden p-1 text-slate-400 hover:text-white focus:outline-none">
    ...
    <main class="flex-1 overflow-x-hidden">
        <header class="header">
            <div class="flex items-center gap-3">
                <button id="mobileMenuBtn" class="lg:hidden p-2 -ml-2 text-slate-600 hover:text-slate-900 focus:outline-none">
                    <i data-lucide="menu" class="w-6 h-6"></i>
                </button>
                <h1 class="font-display text-lg sm:text-xl lg:text-2xl font-bold text-slate-900">Pedidos & POS</h1>
            </div>
            ...
            <div class="modal-body">
                ...
                <div id="stepSelection" class="product-selection-grid">
                    <div>
                          ...
                          <div class="max-h-[50vh] lg:max-h-[60vh] overflow-y-auto pr-2">
    ...
    <script>
        ...
        // Control de menú lateral responsivo (Mobile Sidebar)
