...
<body class="flex">
    ...
    <main class="flex-1 overflow-x-hidden">
        <header class="header">
            <div class="flex items-center gap-3">
                ...
                <h1 class="font-display text-lg sm:text-xl lg:text-2xl font-bold text-slate-900">Panel de Inventario Inteligente</h1>
            </div>
    ...
    <script>
        ...
        @php
            ...
            $labels = $chartData->pluck('date')->map(fn($d) => \Carbon\Carbon::parse($d)->format('d M'))->all();
            $data = $chartData->pluck('daily_total')->all();
